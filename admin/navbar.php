<!-- Navigation -->
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
				<a class="navbar-brand" href="https://www.sourcecodester.com/user/224918/track">HỆ THỐNG PHÂN PHỐI HÀNG HÓA</a>
            </div>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
									...
									<ul class="nav nav-third-level">
                                        <li>
                                            <a href="customer.php"> <i class="fa fa-credit-card"></i> Khách hàng</a>
                                        </li>
                                        <li>
                                ...
                                <li>
                                    ...
                                    <ul class="nav nav-third-level">
                                        <li>
                                            <a href="product.php"> <i class="fa fa-product-hunt"></i> Sản Phẩm</a>
                                        </li>
                                        <li>
