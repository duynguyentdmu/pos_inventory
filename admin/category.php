        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
					...
					<button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#addproduct"><i class="fa fa-plus-circle"></i> Thêm loại sản phầm</button>
				</span>
                    </h1>
                </div>
            </div>
...
<?php include('category1.php.php'); ?>
<?php include('add_category.php.php'); ?>
